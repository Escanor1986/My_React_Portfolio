  ...
  return (
    <li className="px-3 group">
      <a href={props.href} className="block text-center">
        <button className="relative overflow-hidden p-4 bg-dark-bg border-2 border-rose-bg rounded-3xl shadow-lg transition-all duration-500 ease-in-out transform group-hover:scale-105">
